...
(function (e) {
    e.fn.dpNumberPicker = function () {
        ...
        function s(e) {
            while (isNaN(parseFloat(e)) && e.length > 0) e = e.substring(1);
            return parseFloat(e);
        }
        var t = {
            min: false,
        ...
        this.each(function () {
            ...
            if (!t.options.editable) r += " disabled";
            if (t.options.format) r += " value='" + t.options.formatter.call(t, i(t.options.value, t.options.format)) + "' ";
            else r += " value='" + t.options.formatter.call(t, t.options.value) + "' ";
            ...
            t.setValue = function (e) {
                ...
                if (t.options.max !== false && t.options.max < e) e = t.options.max;
                if (t.options.min !== false && t.options.min > e) e = t.options.min;
            ...
            t.update = function () {
                if (t.options.format && t.options.format.length > 0) n.children(".dp-numberPicker-input").val(t.options.formatter.call(t, i(t.options.value, t.options.format)));
